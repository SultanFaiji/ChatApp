    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_SignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    progressDialog.dismiss();
                    Toast.makeText(RegistrationActivity.this, "Password length is too short!", Toast.LENGTH_SHORT).show();
                } else
                {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful())
                            {
                                ...
                                if (imageUri!=null)
                                {
                                    ...
                                    String status = "Hey There! I Am Using This App";
                                    imageURI = "https://firebasestorage.googleapis.com/v0/b/chat--app-7e708.appspot.com/o/profile_image.png?alt=media&token=e38e374f-af78-4b26-ba1a-9b99a3f3b94e";
                                    Users users=new Users(auth.getUid(),name,email,imageURI,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
